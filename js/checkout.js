...
function validateForm() {
  ...
  if (document.forms["shippingForm"]["fname"].value == "") {
    ...
    zipcodeFormat.test(document.forms["shippingForm"]["zipcode"].value) == false
  ) {
    ...
    correctPhoneFormat.test(document.forms["shippingForm"]["phone"].value) ==
    false
  ) {
    ...
    correctEmailFormat.test(document.forms["shippingForm"]["email"].value) ==
    false
  ) {
